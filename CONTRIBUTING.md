...
# Contributing to testamaton

We appreciate your interest in contributing to testamaton! Please review these guidelines before submitting contributions.
...
### Installation
```bash
git clone https://github.com/yourusername/testamaton.git
cd testamaton
uv venv
...
### Running Tests
```bash
pytest --cov=testamaton --cov-report=term-missing
```
